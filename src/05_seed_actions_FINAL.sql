-- =====================================================
-- PASO 1: Insertar ACCIONES faltantes en la tabla actions
-- =====================================================
...
BEGIN
    -- Insertar solo las acciones que NO existen
    ...
    RAISE NOTICE 'Acciones complementarias insertadas/verificadas exitosamente';
END $$;
...
BEGIN
    ...
    PERFORM associate_action('ATT_MANUAL_ENTRY', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('ATT_JUSTIFICATIONS', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('ATT_DEVICE_CONFIG', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('SHIFT_MASTER', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('SHIFT_ROTATION', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('PLAN_CALENDAR', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('PLAN_TEMPLATES', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('PLAN_RESOURCE_ASSIGN', 'UPDATE', v_user_id);
    
    -- Disponibilidad
    PERFORM associate_action('PLAN_AVAILABILITY', 'VIEW', v_user_id);
    PERFORM associate_action('PLAN_AVAILABILITY', 'CREATE', v_user_id);
    PERFORM associate_action('PLAN_AVAILABILITY', 'UPDATE', v_user_id);
    
    -- Conflictos
    PERFORM associate_action('PLAN_CONFLICTS', 'VIEW', v_user_id);
    PERFORM associate_action('PLAN_CONFLICTS', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('ORG_LOCATIONS', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('ORG_POSITIONS', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('ORG_HIERARCHIES', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('EMP_MASTER', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('EMP_PERSONAL_DATA', 'UPDATE', v_user_id);
    
    -- Datos Laborales
    PERFORM associate_action('EMP_WORK_DATA', 'VIEW', v_user_id);
    PERFORM associate_action('EMP_WORK_DATA', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('CFG_GENERAL_PARAMS', 'UPDATE', v_user_id);
    
    -- Días Feriados
    PERFORM associate_action('CFG_HOLIDAYS', 'VIEW', v_user_id);
    PERFORM associate_action('CFG_HOLIDAYS', 'CREATE', v_user_id);
    PERFORM associate_action('CFG_HOLIDAYS', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('CFG_SCHEDULES', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('CFG_ABSENCE_TYPES', 'UPDATE', v_user_id);
    PERFORM associate_action('CFG_ABSENCE_TYPES', 'DELETE', v_user_id);
    
    -- Reglas de Negocio
    PERFORM associate_action('CFG_BUSINESS_RULES', 'VIEW', v_user_id);
    PERFORM associate_action('CFG_BUSINESS_RULES', 'UPDATE', v_user_id);
    
    -- Notificaciones
    PERFORM associate_action('CFG_NOTIFICATIONS', 'VIEW', v_user_id);
    PERFORM associate_action('CFG_NOTIFICATIONS', 'UPDATE', v_user_id);
    
    -- Integrations
    PERFORM associate_action('CFG_INTEGRATIONS', 'VIEW', v_user_id);
    PERFORM associate_action('CFG_INTEGRATIONS', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('SEC_USERS', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('SEC_ROLE_PERMISSIONS', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('SEC_USER_SCOPES', 'UPDATE', v_user_id);
    ...
    PERFORM associate_action('SEC_PASSWORD_POLICIES', 'UPDATE', v_user_id);
...
ORDER BY s.module_name, s.screen_name, a.action_name;
