...
-- La columna correcta es icon_key
-- =====================================================
...
BEGIN
    ...
    SELECT DISTINCT
        smg.menu_group_key,
        smg.menu_group_name,
        smg.icon_key as menu_group_icon,  -- ✅ CORREGIDO: icon_key
    ...
    GROUP BY 
        smg.menu_group_key,
        smg.menu_group_name,
        smg.icon_key,  -- ✅ CORREGIDO: icon_key
        smg.sort_order,
        s.id,
        s.screen_key,
        s.screen_name,
...
-- =====================================================
-- DIAGNÓSTICO: ¿Por qué el permiso de CREATE retorna false?
-- =====================================================

-- Query de diagnóstico corregido
SELECT 
    u.email,
    u.display_name,
    r.role_name,
    s.screen_name,
    a.action_name,
    ur.is_active as user_role_activo,
    rsa.is_active as permiso_activo,
    sa.is_active as screen_action_activo
FROM public.users u
...
-- =====================================================
-- PROBAR NUEVAMENTE user_has_permission
-- =====================================================
