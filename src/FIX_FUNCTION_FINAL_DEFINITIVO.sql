-- ============================================================================
-- FIX DEFINITIVO: get_user_screens CON TODOS LOS NOMBRES CORRECTOS
-- ============================================================================
...
BEGIN
  ...
  IF v_is_super_admin AND NOT v_has_scopes THEN
    ...
    SELECT 
      ...
      COALESCE(smgt.menu_group_name, smg.name)::VARCHAR AS menu_group_name,
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '========================================';
  RAISE NOTICE '✅ FUNCIÓN CORREGIDA COMPLETAMENTE';
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Nombres de columnas corregidos:';
  RAISE NOTICE '  ✅ screens.screen_name (no name)';
  RAISE NOTICE '  ✅ screens.route_path (no route)';
  RAISE NOTICE '  ✅ screens.sort_order (no display_order)';
  RAISE NOTICE '  ✅ screen_translations.screen_name (no display_name)';
  RAISE NOTICE '  ✅ system_menu_group_translations.menu_group_name (no display_name)';
  RAISE NOTICE '========================================';
  RAISE NOTICE '';
END $$;
