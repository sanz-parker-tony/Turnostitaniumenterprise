-- =====================================================
-- CORRECCIÓN DE LA FUNCIÓN get_user_screens
-- El error era que usaba menu_group_icon en lugar de icon_key
-- =====================================================
...
BEGIN
    ...
    SELECT DISTINCT
        smg.menu_group_key,
        smg.menu_group_name,
        smg.icon_key as menu_group_icon,  -- ✅ CORREGIDO: usar icon_key de system_menu_groups
