...
export default function BootstrapUserHelper() {
  ...
  const ensureSystemAdmin = async () => {
    try {
      ...
      const pingUrl = `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/bootstrap/ping`;
      ...
      const createUrl = `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/auth/create-system-admin`;
      console.log('🔧 [BOOTSTRAP] URL:', createUrl);
      ...
      try {
        ...
        console.error('❌ [BOOTSTRAP] Error parseando JSON:', jsonError);
