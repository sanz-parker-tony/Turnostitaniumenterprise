/**
 * AuthDiagnostics - Herramienta de diagnóstico de Supabase Auth
...
export function AuthDiagnostics() {
  ...
  const runDiagnostics = async () => {
    ...
    try {
      const url = `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/auth/diagnostics`;
          ...
          <div className="space-y-4 text-sm text-gray-700">
            <div>
              ...
              <ol className="list-decimal list-inside space-y-1 ml-2">
                <li>Ve a <strong>Supabase Dashboard → Authentication → Email Auth</strong></li>
