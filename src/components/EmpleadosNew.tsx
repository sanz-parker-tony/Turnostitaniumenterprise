...
import { Plus, Edit, Trash2, Search, User, Calendar, Clock, FileText, Download, ChevronLeft, ChevronRight, X, Save, PlayCircle, Fingerprint, UserCircle } from 'lucide-react';
...
import PlanificacionTurnos from './PlanificacionTurnos';
...
export default function Empleados() {
  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        <h1 className="text-2xl mb-1">Empleados</h1>
