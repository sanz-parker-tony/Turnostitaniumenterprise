/**
 * CatalogManagement - Gestión de Catálogos (lookup_groups/lookup_values)
 * Pantalla MAINTENANCE para TENANT_ADMIN
 */
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Administra los catálogos del sistema (lookup_groups/lookup_values)
          </p>
        </div>
      ...
      <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-8">
        <div className="flex flex-col items-center justify-center text-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-semibold">Gestión de Catálogos</h3>
            <p className="text-sm text-muted-foreground mt-1">
              Esta pantalla permitirá crear y editar catálogos del sistema
            </p>
          </div>
