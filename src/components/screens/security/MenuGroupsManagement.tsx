...
const API = `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/menu-groups-management`;
  ...
  const loadGroupScreens = async (groupId: string) => {
    ...
    try {
      const res = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/screens-management`,
        { headers: headers() }
      );
