...
const API = `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/screens-management`;
const SA_API = `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/screen-actions-management`;
