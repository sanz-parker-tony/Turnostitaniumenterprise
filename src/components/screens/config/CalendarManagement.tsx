  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Gestión de Calendarios</h1>
          <p className="text-muted-foreground mt-1">
            Administra calendarios laborales y días festivos
          </p>
        </div>
      ...
      <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-8">
        <div className="flex flex-col items-center justify-center text-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-semibold">Gestión de Calendarios</h3>
            <p className="text-sm text-muted-foreground mt-1">
              Esta pantalla permitirá configurar calendarios laborales
            </p>
          </div>
