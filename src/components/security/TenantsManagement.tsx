...
export default function TenantsManagement() {
  ...
  const handleUpdateTenantName = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/tenants/${tenant.id}`,
        {
          method: 'PUT',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const handleSaveSetting = async () => {
    ...
    try {
      ...
      const url = editingSetting
        ? `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/tenants/${tenant.id}/settings/${editingSetting.id}`
        : `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/tenants/${tenant.id}/settings`;
  ...
  const handleDeleteSetting = async (setting: TenantSetting) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/tenants/${tenant.id}/settings/${setting.id}`,
        {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const handleSaveLanguages = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-e19f2094/tenants/${tenant.id}/languages`,
        {
          method: 'PUT',
          headers: {
            'Authorization': `Bearer ${token}`,
