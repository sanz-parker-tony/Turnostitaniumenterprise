...
export default function Procesos({ activeTab: initialTab = 'depuracion', title = 'Procesos' }: { activeTab?: string; title?: string }) {
    ...
    <div className="p-8 space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={(v) => { setActiveTab(v); setCurrentPage(1); setSearchTerm(''); setStatusFilter('all'); }}>
        ...
        <TabsList className="hidden">
          <TabsTrigger value="depuracion">Depuración de Marcaciones</TabsTrigger>
          <TabsTrigger value="liquidacion">Liquidación de Empleados</TabsTrigger>
          <TabsTrigger value="generacion">Generación de Novedades</TabsTrigger>
          <TabsTrigger value="aprobacion">Aprobación de Novedades</TabsTrigger>
          <TabsTrigger value="administracion">Administración de Procesos</TabsTrigger>
        </TabsList>
