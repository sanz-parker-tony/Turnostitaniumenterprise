-- =====================================================
-- CREAR ROL "SUPER ADMIN" CON ACCESO TOTAL - SIN ON CONFLICT
-- =====================================================
...
BEGIN
    -- =====================================================
    -- PASO 1: Crear o actualizar el rol "Super Admin"
    -- =====================================================
    ...
    -- Luego insertar todas las screen_actions
    ...
    -- =====================================================
    -- PASO 3: Crear o actualizar scope "TODAS"
    -- =====================================================
