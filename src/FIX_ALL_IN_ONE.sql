...
-- ============================================================================
-- Este script ejecuta TODO lo necesario en orden:
-- 1. Fix función get_user_screens duplicada (PGRST203)
-- 2. Fix estructura de usuario/tenant/roles
...
BEGIN
  ...
  -- 2. Obtener tenant_name (CORREGIDO: usa tenant_name)
...
RAISE NOTICE '✅ Función get_user_screens recreada correctamente';
...
BEGIN
  ...
  IF v_tenant_id IS NULL THEN
    INSERT INTO tenants (tenant_name, is_active, created_by, updated_by)
    VALUES ('Titanium Corp', true, 'system', 'system')
