...
export async function getWizardState(req: Request, res: Response) {
  try {
...
export async function getBootstrapToken(req: Request, res: Response) {
  return res.json({
...
export async function getSystemLanguages(req: Request, res: Response) {
  try {
    const Postgres = createDbClient(
      process.env.Postgres_URL ?? '',
      process.env.Postgres_SERVICE_ROLE_KEY ?? ''
...
export async function bootstrapStep1Tenant(req: Request, res: Response) {
  try {
    const body = req.body;
...
export async function bootstrapStep2Admin(req: Request, res: Response) {
  try {
    const body = req.body;
