 ...
 */
export async function getSystemTenantSettings(req, res) {
    try {
 ...
 */
export async function updateSystemTenantSettings(req, res) {
    try {
        const body = req.body;
 ...
 */
export async function createTenantSetting(req, res) {
    try {
        const tenantId = req.params.id;
        const body = req.body;
        const Postgres = getPostgresClient();
 ...
 */
export async function updateTenantSetting(req, res) {
    try {
 ...
 */
export async function deleteTenantSetting(req, res) {
    try {
        const settingId = req.params.setting_id;
        const Postgres = getPostgresClient();
 ...
 */
export async function getTenantMembers(req, res) {
    try {
        const tenantId = req.params.id;
        const Postgres = getPostgresClient();
        const { data, error } = await Postgres
 ...
 */
export async function getDataTypes(req, res) {
    try {
        const Postgres = getPostgresClient();
 ...
 */
export async function getTenantLanguages(req, res) {
    try {
        const tenantId = req.params.id;
        const Postgres = getPostgresClient();
        const { data, error } = await Postgres
 ...
 */
export async function updateTenantLanguages(req, res) {
    try {
        const tenantId = req.params.id;
        const body = req.body;
 ...
 */
export async function ensureMainTenant(req, res) {
    try {
        const Postgres = getPostgresClient();
