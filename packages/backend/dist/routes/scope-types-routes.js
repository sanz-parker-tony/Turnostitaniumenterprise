...
router.put('/:id', async (req, res) => {
    try {
        ...
        if (scope_type_key !== undefined)
            updateData.scope_type_key = scope_type_key.toUpperCase();
        if (scope_type_name !== undefined)
            updateData.scope_type_name = scope_type_name;
...
//# sourceMappingURL=scope-types-routes.js.map