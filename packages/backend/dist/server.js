...
(_a = process.env).DATABASE_URL || (_a.DATABASE_URL = 'postgresql://postgres:51mul4cr05.5n9r-2025@192.168.71.104:5432/tt_db');
(_b = process.env).Postgres_URL || (_b.Postgres_URL = process.env.DATABASE_URL);
(_c = process.env).Postgres_SERVICE_ROLE_KEY || (_c.Postgres_SERVICE_ROLE_KEY = 'local-postgres');
(_d = process.env).Postgres_ANON_KEY || (_d.Postgres_ANON_KEY = 'local-postgres');
const app = express();
