...
const ENTITY_CONFIGS: EntityConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'shift_duration_minutes', label: 'Duracion total del intervalo (min)', type: 'number', required: true },
      { key: 'work_minutes', label: 'Minutos efectivos de trabajo', type: 'number', required: true },
      { key: 'lunch_minutes', label: 'Minutos efectivos de lunch', type: 'number', required: true, defaultValue: 0 },
      { key: 'lunch_window_minutes', label: 'Ventana disponible para lunch (min)', type: 'number', required: true, defaultValue: 0 },
      { key: 'lunch_is_paid', label: 'Lunch pagado', type: 'boolean', defaultValue: false },
      { key: 'lunch_deduction_mode', label: 'Modo descuento lunch', type: 'text' },
    ...
    tableColumns: ['shift_short_name', 'shift_name', 'shift_icon_key', 'company_id', 'start_time', 'shift_duration_minutes', 'work_minutes', 'lunch_minutes', 'lunch_window_minutes', 'lunch_is_paid', 'entry_grace_minutes', 'exit_grace_minutes', 'is_active'],
  },
  {
