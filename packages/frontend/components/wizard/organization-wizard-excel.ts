...
export const ORGANIZATION_TEMPLATE_COLUMNS: Record<OrganizationEntityKey, OrganizationTemplateColumn[]> = {
  companies: [
    ...
    { key: 'legacy_id', required: true, example: 'EMP-001' },
  ...
  work_locations: [
    ...
    { key: 'legacy_id', required: true, example: 'LOC-UIO' },
  ...
  cost_centers: [
    ...
    { key: 'legacy_id', required: true, example: 'CC-001' },
  ...
  employee_profiles: [
    ...
    { key: 'legacy_id', required: true, example: 'PERF-ADM' },
    { key: 'is_active', example: 'true' },
  ],
};
